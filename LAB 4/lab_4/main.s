...
; main function 
	...
	STR r9, [r3] ; Store R9 in the word pointed by R3.
	MOV r9, #10 ; Moves in the immeadiate value of 10 into R9.
	MUL r8, r6, r9 ; 7.	Multiply R8 by 10 and store the result in the word pointed by R0.
	STR r8, [r4] ; Store R8 in the word pointed by R4.
	MOV r9, #2 ; Moves the immeadiate value of 2 into R9.
	UDIV r8, r6, r9 ; 8. Divide R6 by 2 using unsigned division and store the result in the word pointed by R5.
	STR r8, [r5] ; Store R8 in the word pointed by R5.
	
	; PART 2
	LDRB r6, [r0, #1] ; Load a byte from R0 into R6 - PreIndex Update Increment by 1 byte.
	UXTB r6, r6 ; 2. Extend the byte pointed by R0 using unsigned extension and store the result in R6.
	LDRB r7, [r0, #1] ; Load a byte from R0 into R7 - PreIndex Update Increment by 1 byte.
	SXTB r7, r7 ; 3. Extend the byte pointed by R0 using signed extension and store the result in R7.
	STR r6, [r2, #4]! ; 4. Store R6 in the word pointed by R2 - PreIndex with Update Increment by 4.
	STR r7, [r1, #4]! ; 5. Store R7 in the word pointed by R1 - PreIndex with Update Increment by 4.
	ADD r9, r6, r7 ; 6.	Add R6 and R7 and store the result in the word pointed by R3. 
	STR r9, [r3, #4]! ; Store R9 in the word pointed by R3 - PreIndex with Update Increment by 4.
	MOV r9, #10 ; Moves in the immeadiate value of 10 into R9.
	MUL r8, r6, r9 ; 7.	Multiply R8 by 10 and store the result in the word pointed by R0. 
	STR r8, [r4, #4]! ; Store R8 in the word pointed by R4 - PreIndex with Update Increment by 4.
	MOV r9, #2 ; Moves the immeadiate value of 2 into R9.
	UDIV r8, r6, r9 ; 8. Divide R6 by 2 using unsigned division and store the result in the word pointed by R5. 
	STR r8, [r5, #4]! ; Store R8 in the word pointed by R5 - PreIndex with Update Increment by 4.

	; PART 3
	LDRB r6, [r0, #2] ; Load a byte from R0 into R6 - PreIndex Update Increment by 2 byte.
	UXTB r6, r6 ; 2. Extend the byte pointed by R0 using unsigned extension and store the result in R6.
	LDRB r7, [r0, #2] ; Load a byte from R0 into R7 - PreIndex Update Increment by 2 byte.
	SXTB r7, r7 ; 3. Extend the byte pointed by R0 using signed extension and store the result in R7.
	STR r6, [r2, #4]! ; 4. Store R6 in the word pointed by R2 - PreIndex with Update Increment by 4.
	STR r7, [r1, #4]! ; 5. Store R7 in the word pointed by R1 - PreIndex with Update Increment by 4.
	ADD r9, r6, r7 ; 6.	Add R6 and R7 and store the result in the word pointed by R3.
	...
	; PART 4
	LDRB r6, [r0, #3] ; Load a byte from R0 into R6 - PreIndex Update Increment by 3 byte.
	UXTB r6, r6 ; 2. Extend the byte pointed by R0 using unsigned extension and store the result in R6.
	LDRB r7, [r0, #3] ; Load a byte from R0 into R7 - PreIndex Update Increment by 3 byte.
	SXTB r7, r7 ; 3. Extend the byte pointed by R0 using signed extension and store the result in R7.
	STR r6, [r2, #4]! ; 4. Store R6 in the word pointed by R2 - PreIndex with Update Increment by 4.
	STR r7, [r1, #4]! ; 5. Store R7 in the word pointed by R1 - PreIndex with Update Increment by 4.
	ADD r9, r6, r7 ; 6.	Add R6 and R7 and store the result in the word pointed by R3.
